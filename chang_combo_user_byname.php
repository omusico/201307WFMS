...
//change_combo_user.php
    ...
    else
    {
        ...
        $sql = $sql.$free_it_call_time.", message_count_per_month = ".$free_message_count.", flow_count_per_month = ".$free_flow_count." where phone_number = '".$_COOKIE['phone_number']."';";
        echo $sql;
        $res = mysqli_query($mysqli, $sql);
        if($res == FALSE)
        {
        ...
        mysqli_close($mysqli);
        header("Location: change_combo_successfully_user.html");
    }
?>
